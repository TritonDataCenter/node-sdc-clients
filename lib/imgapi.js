 ...
 */
IMGAPI.prototype.createFromVm =
function createFromVm(data, options, account, callback) {
    var self = this;
    assert.object(data, 'data');
    assert.object(options, 'options');
 ...
 * @param {Function} callback : `function (err, image, res)`
 */
IMGAPI.prototype.createFromVmAndWait =
function createFromVmAndWait(data, options, account, callback) {
    var self = this;
    var fn;
    if (callback === undefined) {
        callback = account;
        account = undefined;
        fn = self.createFromVm.bind(self, data, options);
    } else {
        fn = self.createFromVm.bind(self, data, options, account);
    }
...
/**
 * DEPRECATED. Use adminImportRemoteImageAndWait instead
 *
 ...
 * @param {Function} callback : `function (err, image, res)`
 */
IMGAPI.prototype.importImage = function importImage(
        uuid, source, options, callback) {
    var self = this;
    if (callback === undefined) {
        callback = options;
        options = {};
