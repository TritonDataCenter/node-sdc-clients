 ...
 * can specify the channel in the constructor:
 *
 *      var client = imgapi.createClient({
 *          url: <URL>,
 *          channel: <CHANNEL>
 ...
 *        header in requests to the IMGAPI server. This defaults to '*',
 *        meaning that over time you could experience breaking
