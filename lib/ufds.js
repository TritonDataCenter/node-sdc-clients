        ...
        self.connecting = createClient(self.ldapOpts, function (err, client) {
            ...
            function handleClose() {
                if (self.client && !self.connecting && !self.closed) {
                    self.log.warn('LDAP client disconnected');
                    self.client = null;
                }
            }
            ...
            // HAProxy timeout client is set to 55000
            client.socket.setTimeout(50000, function () {
        ...
        vasync.pipeline({
            ...
            funcs: [
                ...
                function reconnect(opts, cb) {
                    ...
                    console.log('\nKILL THE UFDS SERVER OR WAIT 50 SECONDS ' +
