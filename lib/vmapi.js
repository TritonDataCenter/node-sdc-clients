...
VMAPI.prototype.updateVm = function (params, callback) {
    ...
    // PUBAPI-444: Trying to find the reason for randomly missing resize
    // params.
    this.client.log.info({params: params}, 'updateVm params');
...
VMAPI.prototype.snapshotVm = function (params, callback) {
    ...
    return this.post(format('/vms/%s/snapshot', params.uuid), query, callback);
};
...
VMAPI.prototype.rollbackVm = function (params, callback) {
    ...
    return this.post(format('/vms/%s/rollback', params.uuid), query, callback);
};
