 ...
 */
ZAPI.prototype.listVms = function(params, callback) {
 ...
 * @param {Function} callback : of the form f(err, res).
 */
ZAPI.prototype.getVm = function(params, callback) {
  var query = {};
 ...
 * @param {Function} callback : of the form f(err, res).
 */
ZAPI.prototype.createVm = function(params, callback) {
  if (!params || typeof(params) !== 'object')
    throw new TypeError('params is required (object)');
 ...
 * @param {Function} callback : of the form f(err, res).
 */
ZAPI.prototype.stopVm = function(params, callback) {
 ...
 * @param {Function} callback : of the form f(err, res).
 */
ZAPI.prototype.startVm = function(params, callback) {
 ...
 * @param {Function} callback : of the form f(err, res).
 */
ZAPI.prototype.rebootVm = function(params, callback) {
 ...
 * @param {Function} callback : of the form f(err, res).
 */
ZAPI.prototype.deleteVm = function(params, callback) {
  if (!params || typeof(params) !== 'object')
    throw new TypeError('params is required (object)');
  if (!params.uuid)
    throw new TypeError('UUID is required');
