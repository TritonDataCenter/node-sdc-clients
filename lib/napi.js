 ...
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.getNicTag = function (uuid, options, callback) {
    if (!uuid)
        throw new TypeError('uuid is required (string)');
    if (typeof (options) === 'function') {
        callback = options;
    ...
    var opts = { path: format('/nic_tags/%s', uuid) };
    if (options && options.headers) {
        opts.headers = options.headers;
    }
 ...
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.updateNicTag = function (uuid, params, options, callback) {
    if (!uuid)
        throw new TypeError('uuid is required (string)');
    if (!params || typeof (params) !== 'object')
        throw new TypeError('params is required (object)');
 ...
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.deleteNicTag = function (uuid, params, options, callback) {
    if (!uuid)
        throw new TypeError('uuid is required (string)');
    if (typeof (params) === 'function') {
        callback = params;
    ...
    var opts = { path: format('/nic_tags/%s', uuid), query: params };
    if (options && options.headers) {
        opts.headers = options.headers;
    }
...
/**
 * Gets an Aggregation by UUID.
 *
 * @param {String} uuid : the UUID.
 * @param {Object} options : Request options.
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.getAggr = function (uuid, options, callback) {
    assert.string(uuid, 'uuid');
    if (typeof (options) === 'function') {
        callback = options;
        options = undefined;
    ...
    var opts = { path: format('/aggregations/%s', uuid) };
    if (options && options.headers) {
        opts.headers = options.headers;
    }
...
/**
 * Updates the Aggregation specified by UUID.
 *
 * @param {String} uuid : the UUID.
 * @param {Object} params : the parameters to update.
 * @param {Object} options : Request options.
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.updateAggr = function (uuid, params, options, callback) {
    assert.string(uuid, 'uuid');
    assert.object(params, 'params');
...
/**
 * Deletes an Aggregation by UUID.
 *
 * @param {String} uuid : the UUID.
 * @param {Object} params : optional parameters.
 * @param {Object} options : Request options.
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.deleteAggr = function (uuid, params, options, callback) {
    assert.string(uuid, 'uuid');
    if (typeof (params) === 'function') {
        callback = params;
        params = {};
    ...
    var opts = { path: format('/aggregations/%s', uuid), query: params };
    if (options && options.headers) {
        opts.headers = options.headers;
    }
