 ...
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.createVPC = function (params, options, callback) {
    var opts;
 ...
 *
 * @param {String} id : The UUID of the VPC.
 * @param {Object} params : Required reqest parameters.
 * @param {Object} options : Optional request options.
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.getVPC = function (id, params, options, callback) {
    var opts;
 ...
 * Update a VPC
 *
 * @param {String} id : The VPC UUID.
 * @param {String} params : Required request parameters.
 * @param {String} options : Optional request options.
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.updateVPC = function (id, params, options, callback) {
    var opts;
 ...
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.deleteVPC = function (id, params, options, callback) {
    var opts;
...
/**
 * List Networks on a VPC.
 *
 * @param {String} vpc : The VPC UUID
 * @param {Object} params : Required request parameters.
 * @param {Object} options : Optional request options.
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.listVPCNetworks = function (vpc, params, options, callback) {
    var opts;

    assert.string(vpc, 'vpc');
    assert.object(params, 'params');
    ...
    opts = {
        path: format('/vpc/%s/networks', vpc),
        query: params
    };
    if (options && options.headers) {
        opts.headers = options.headers;
...
/**
 * Create a Network on a VPC.
 *
 * @param {String} vpc : The VPC UUID.
 * @param {String} params : Required Network parameters.
 * @param {String} options : Optional request options.
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.createVPCNetwork = function (vpc, params, options, callback) {
    var opts;
...
/**
 * Update a Network on a VPC
 *
 * @param {String} vpc : The VPC UUID.
 * @param {String} id : The network UUID of this network.
 * @param {String} options : Optional request options.
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.updateVPCNetwork =
        function (vpc, id, params, options, callback) {
    var opts;
    ...
    opts = {
        path: format('/vpc/%s/networks/%s', vpc, id),
        query: params
    };
    if (options && options.headers) {
        opts.headers = options.headers;
 ...
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.getVPCNetwork = function (vpc, id, params, options, callback) {
    var opts;
 ...
 * @param {Function} callback : of the form f(err, res).
 */
NAPI.prototype.deleteVPCNetwork =
        function (vpc, id, params, options, callback) {
    var opts;
