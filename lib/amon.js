 ...
 * @param {String} user : the user uuid.
 * @param {String} uuid : probe UUID.
 * @param {Function} cb : callback of the form f(err, account).
 */
...
/**
 * Gets alarms for a User
 *
 * @params {String} user : the user uuid
 * @params {Function} callback : callback of the form fn(err, alarmas)
 */
Amon.prototype.getAlarms = function (user, cb) {
    assert.string(user, 'user');
