...
function recentChanges(role, changenumber, cb) {
    ...
    LOG.info('searching for %s', searchdn);
    ...
    self.client.search(CHANGELOG, searchopts, function (err, res) {
        ...
        res.on('searchEntry', function (entry) {
            ...
            if (targetdn.equals(searchdn) ||
                ...
                LOG.debug({ obj: entry.object }, 'full change object');
        ...
        res.on('end', function (result) {
            LOG.info('found %d changes for %s', changes.length, searchdn);
